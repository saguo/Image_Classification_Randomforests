...
incre_func = @IGT; % incre_fuc: specific function for tree increment: baseline, ULS, IGT, RTST, RTSTQ
...
[train_error, test_error, train_time, test_time, pred, sroot] = oneclickresult(data_train, data_test, train_num, test_num...
